...
\section{O que vem (Passo 2)}

Com os 72 vetores $\theta_t$ em mãos, o Passo~2 modela a \emph{dinâmica} deles: como
evoluem (random walk / Kalman), como o nível médio responde a preço e beta, e usa
isso para \textbf{prever} a vários horizontes. O produto final é uma \emph{matriz de
erros} (resíduos fundo $\times$ mês), cujas propriedades (média zero, estabilidade)
dizem o quão bem o modelo captura as posições.
