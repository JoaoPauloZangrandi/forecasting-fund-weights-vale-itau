...
cabe perguntar o que a determina. Cruzando o desvio-padrão do erro de cada gestora contra beta
médio do fundo, tamanho médio (log do PL) e concentração média da carteira (índice HHI dos
pesos por ativo, dentro de cada fundo-mês) --- as três características mais plausíveis à primeira
vista --- a concentração se destaca claramente: correlação de $0{,}71$ ($R^2=0{,}50$), contra
$0{,}52$ ($R^2=0{,}27$) do beta e apenas $0{,}17$ ($R^2=0{,}03$) do tamanho.
...
e~\ref{fig:explica-variancia}) partiu de beta:
\begin{equation}
...
da amostra por gestora ($h=1$) explicado pelas cinco características da Etapa 1 e pela
concentração média, juntas. 40 gestoras.}
\label{tab:regressao-variancia}
\begin{tabular}{@{}lrrc@{}}
\toprule
Variável & Coeficiente & $t$ & Sig. \\
\midrule
Intercepto ($\alpha$) & $-0{,}0162$ & $-1{,}28$ & n.s. \\
Beta médio do fundo ($\beta_1$) & $0{,}0018$ & $0{,}76$ & n.s. \\
Tamanho médio, log AUM ($\beta_2$) & $0{,}0011$ & $1{,}48$ & n.s. \\
Cotistas médio, log ($\beta_3$) & $0{,}00002$ & $0{,}05$ & n.s. \\
\% FIC ($\beta_4$) & $-0{,}0019$ & $-0{,}95$ & n.s. \\
Fluxo/AUM médio ($\beta_5$) & $-0{,}0229$ & $-1{,}86$ & $\dagger$ \\
Concentração média, HHI ($\beta_6$) & $0{,}0945$ & $4{,}18$ & *** \\
\midrule
$R^2$ & \multicolumn{3}{r}{$0{,}58$} \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Variável dependente: desvio-padrão do erro fora da amostra por gestora
($h=1$). $^{***}p<0{,}1\%$; $^{\dagger}p<10\%$ (mas $p=0{,}07$, acima do corte convencional de
$5\%$); n.s. = não significativo a $10\%$.}
\end{table}

O resultado responde à pergunta: mesmo com as cinco características da Etapa 1 todas presentes,
só a concentração ($\beta_6$) continua estatisticamente significativa --- beta e tamanho, que
pareciam relevantes sozinhos (Figura~\ref{fig:explica-variancia}), perdem significância quando a
concentração entra na mesma regressão; cotistas e o indicador de FIC nunca chegam perto de
significativos. Isso sugere que a relação entre beta e RMSE mostrada na Figura~\ref{fig:beta-erro}
a seguir é, em boa parte, um reflexo indireto da concentração --- gestoras com fundos de beta
alto tendem também a manter carteiras mais concentradas, e é a concentração, não o beta em si,
que parece determinar o quão imprevisível é a mudança de posição. O único candidato que chega
perto de disputar espaço com a concentração é o fluxo de captação/resgate ($\beta_5$,
$p=0{,}07$): gestoras cujos fundos captam mais recursos, em média, tendem a ter erro um pouco
menos disperso --- plausível (fundos crescendo de forma mais estável tendem a ser mais
previsíveis), mas o efeito não passa do corte convencional de significância a $5\%$ com apenas
40 gestoras na amostra.
