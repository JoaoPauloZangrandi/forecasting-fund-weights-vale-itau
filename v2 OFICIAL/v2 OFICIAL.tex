...
\caption{Ativo com mais e menos erro fora da amostra ($h{=}1$), por gestora --- ordenado do maior
RMSE para o menor.}\\
\toprule
...
\bottomrule
\multicolumn{5}{@{}p{0.95\textwidth}@{}}{\footnotesize Fonte: elaboração própria
(\texttt{scripts/46\_erro\_ativo\_por\_gestora\_e\_fundo.R},
...
Kapitalo Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0338$ & RODOBENSIMOB ON NM - RDNI3 &
$0{,}0001$ \\
AZ Quest & VALE ON N1 - VALE3 & $0{,}0337$ & IOCHP-MAXION ON NM - MYPK3 & $0{,}0003$ \\
Ibiuna Investimentos & BRADESCO PN N1 - BBDC4 & $0{,}0309$ & ENGIE BRASIL ON NM - EGIE3 &
$0{,}0005$ \\
...
Constellation Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0181$ & CVC BRASIL ON NM -
CVCB3 & $0{,}0002$ \\
...
Santander Brasil Asset Management & VALE ON N1 - VALE3 & $0{,}0174$ & VIVEO ON NM - VVEO3 &
$0{,}0005$ \\
...
Julius Baer Family Office & VALE ON N1 - VALE3 & $0{,}0129$ & WILSON SONS ON NM - PORT3 &
$0{,}0004$ \\
...
($49\%$) têm VALE3 como o ativo de maior erro fora da amostra; somando Petrobras ($5$ gestoras),
mais de $60\%$ das gestoras têm uma dessas duas \emph{blue chips} como seu ponto cego. Não é
coincidência --- confirma, com uma terceira metodologia independente, o mesmo padrão já visto na
Tabela~20 (VALE3 é o $2^o$ ativo com erro mais disperso \textbf{dentro} da amostra, atrás só da
Petrobras) e discutido na Seção~6.2 (o beta do fundo, que mais separa fundos ``equity-like'' de
``conservadores'', é dominado pela variação nessas ações mais representativas do índice). Pro
robô: mesmo dentro de gestoras consideradas ``previsíveis'' no agregado (Tabela~25), VALE3 e
Petrobras são candidatas naturais a ficarem de fora de qualquer tentativa de replicar posições com
alta confiança --- o erro se concentra ali de forma sistemática, gestora após gestora.}
...
\item \textbf{Qual ativo específico puxa o erro, por gestora:} quebrando o erro fora da amostra
($h=1$) por (gestora, ativo), $19$ das $39$ gestoras elegíveis ($49\%$) têm \textbf{VALE3} como o
ativo de maior erro dentro do próprio book; somando Petrobras ($5$ gestoras), mais de $60\%$.
Confirma, com uma terceira metodologia independente, o mesmo padrão da Tabela~20 (VALE3 é o
$2^o$ ativo com erro mais disperso dentro da amostra) --- mesmo gestoras consideradas
``previsíveis'' no agregado erram sistematicamente mais nessas duas \emph{blue chips}.
\end{enumerate}
