...
não pelas $8,25$ milhões de observações brutas (que tornaria qualquer diferença minúscula
...
\midrule
\endfirsthead
\multicolumn{6}{l}{\textit{Tabela 12 (continuação)}}\\
\toprule
Gestora & Obs. & Meses & Média & Sig. & dp \\
\midrule
\endhead
...
Rótulos legíveis só nos extremos --- a Tabela~12 tem os valores exatos das $41$.}
\end{figure}
