...
Tabela~8, sem filtro de cobertura). Duas delas têm pouquíssimos meses --- Legacy Capital ($1$ mês,
...
\midrule
\endfirsthead
\multicolumn{6}{l}{\textit{Tabela 11 (continuação)}}\\
\toprule
Gestora & Obs. & Meses & Média & Sig. & dp \\
\midrule
\endhead
...
Rótulos legíveis só nos extremos --- a Tabela~11 tem os valores exatos das $41$.}
\end{figure}
