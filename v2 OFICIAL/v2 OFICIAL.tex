...
\bottomrule
\end{tabular}
\caption*{\footnotesize ``Meses'' = quantos dos 59 meses aquela gestora teve dados suficientes
para entrar na regressão (nem toda gestora tem VALE3 o período inteiro). $t$ e significância:
teste ingênuo sobre a média dos coeficientes mensais, mesmo estilo das demais tabelas. Fonte:
