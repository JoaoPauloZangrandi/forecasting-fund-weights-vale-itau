...
\item \textbf{Qual ativo específico puxa o erro, por gestora (top-3):} quebrando o erro fora da
amostra ($h=1$) por (gestora, ativo), $19$ das $39$ gestoras elegíveis ($49\%$) têm
\textbf{VALE3} como o ativo de \textbf{maior} erro; olhando o top-3 inteiro, $29$ ($74\%$) têm
VALE3 em algum dos três, e $33$ ($85\%$) têm VALE3, Petrobras \textbf{ou} Itaú Unibanco. Confirma,
com uma terceira metodologia independente, o mesmo padrão da Tabela~20 (VALE3 é o $2^o$ ativo com
erro mais disperso dentro da amostra) --- mesmo gestoras consideradas ``previsíveis'' no agregado
erram sistematicamente mais nessas \emph{blue chips}.
\end{enumerate}
