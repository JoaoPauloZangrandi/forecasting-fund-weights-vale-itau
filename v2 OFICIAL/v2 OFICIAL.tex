...
Note que $\widehat\lambda_{\text{treino}}=0{,}1951$ é uma estimativa \textbf{diferente} do
$\widehat\lambda=0{,}1534$ da Etapa 2 --- a Etapa 2 usa a amostra inteira (2017--2021), a Etapa 3
usa só o treino (2017--2019), deliberadamente, para não vazar informação do período de teste na
estimação. As duas são estimativas do mesmo parâmetro conceitual (velocidade de ajuste), só que em
janelas de dados diferentes. O erro fora da amostra reportado a seguir é definido usando esse
$\lambda$ de treino, não o da Etapa 2 --- $\lambda$ entra diretamente dentro da fórmula do erro
($\text{erro}=dw_{\text{real}}-\widehat\lambda_{\text{treino}}\cdot d$), então a pergunta que a
Etapa 3 testa é, na prática, se esse $\lambda$ estimado só com dados antigos ainda funciona bem em
dados novos que o modelo nunca viu.
...
\begin{figure}[h]\centering
\includegraphics[width=0.75\textwidth]{fig_multihorizonte_gestora_rmse_margem.pdf}
...
Rótulos legíveis só nos extremos --- as Tabelas~25 e~26 têm os valores exatos das $41$.}
\end{figure}

\aha{O gráfico deixa visível que os $4$ casos de margem negativa \textbf{não} formam um grupo
único --- estão espalhados em posições bem diferentes no eixo $x$. Guepardo fica no extremo
direito (RMSE mais alto de todos) só ligeiramente abaixo de zero; Plural e XP ficam no extremo
esquerdo (RMSE baixíssimo) bem mais abaixo de zero; Legacy Capital (cobertura mínima, ver
Adendo de processo anterior) é o ponto mais negativo do gráfico. Não existe uma relação simples
entre ``difícil de prever'' e ``a fórmula ajuda'' --- os dois eixos capturam problemas
genuinamente diferentes, reforçando que o robô precisa olhar as duas medidas separadamente, não
só uma proxy da outra.}

\begin{figure}[h]\centering
\includegraphics[width=0.75\textwidth]{fig_multihorizonte_gestora_rmse_margem_h3.pdf}
\caption{Mesmo gráfico da Figura~14, agora em $h{=}3$.}
\end{figure}

\aha{Em $h{=}3$ ($40$ gestoras --- Legacy Capital cai por falta de dado nesse horizonte), os
mesmos $4$ casos continuam negativos (Guepardo, Núcleo Capital, XP, Plural), mas se juntam a
eles \textbf{dois novos}: TNA Gestão Patrimonial e Bogari Capital, que em $h{=}1$ tinham margem
positiva ou perto de zero e viram negativos em $h{=}3$ (já visível na Tabela~26: TNA
$+0{,}1\%\to-1{,}6\%$; Bogari $-0{,}8\%\to-0{,}2\%$, ambos oscilando perto de zero e cruzando pra
negativo). Confirma o padrão da Tabela~26: o grupo ``sempre negativo'' (Guepardo, Núcleo Capital,
XP, Plural) é estável, mas existe um segundo grupo, maior, que \textbf{oscila} em torno de zero
dependendo do horizonte --- vale considerar os dois grupos separadamente no desenho do robô: um
núcleo duro de gestoras onde o ajuste parcial nunca ajuda, e uma franja de casos-limite.}

\subsubsection*{Por gestora, qual ativo específico puxa o erro}

\pergunta{As Tabelas~25 e~26 agregam o erro de cada gestora em todas as ações. Dentro do book de
cada gestora, qual ativo específico é o mais difícil de prever, e qual é o mais fácil?}

Mesmos dados de $h{=}1$, agora quebrados por (gestora, ativo) em vez de só por gestora ---
reaproveita as mesmas observações de erro fora da amostra, só muda o nível de agregação.

\textbf{Adendo de processo:} sem filtro, o ativo ``menos errante'' de cada gestora repetia o
mesmo artefato de posição-poeira já visto várias vezes nesta seção --- RMSE exatamente $0$ em
ativos que a gestora praticamente nunca carrega de verdade (ex.: margens de $-500.000\%$, sem
nenhum sentido econômico). Mesmo filtro de sempre (peso mediano da célula gestora-ativo
$>0{,}1\%$, $\geq24$ observações), restando $2.542$ células (gestora, ativo) de $9.063$, cobrindo
$39$ das $41$ gestoras.

\begin{center}\scriptsize
\begin{longtable}{@{}lp{3.9cm}rp{3.9cm}r@{}}
\caption{Top-3 ativos com mais e menos erro fora da amostra ($h{=}1$), por gestora --- ordenado
do maior RMSE (rank 1) para o menor.}\\
\toprule
Gestora & Ativo (mais erro) & RMSE & Ativo (menos erro) & RMSE \\
\midrule
\endfirsthead
\multicolumn{5}{l}{\textit{Tabela 27 (continuação)}}\\
\toprule
Gestora & Ativo (mais erro) & RMSE & Ativo (menos erro) & RMSE \\
\midrule
\endhead
...
\endfoot
\bottomrule
\multicolumn{5}{@{}p{0.95\textwidth}@{}}{\footnotesize Cada gestora ocupa 3 linhas (rank 1 a 3).
Fonte: elaboração própria (\texttt{scripts/46\_erro\_ativo\_por\_gestora\_e\_fundo.R},
\texttt{47\_tabela\_erro\_ativo\_por\_gestora.R}).}\\
\endlastfoot
Guepardo Investimentos & JSL ON NM - JSLG3 & $0{,}0756$ & SIMPAR ON NM - SIMH3 & $0{,}0005$ \\
Guepardo Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0273$ & IMC S/A ON NM - MEAL3 & $0{,}0017$ \\
Guepardo Investimentos & GERDAU PN N1 - GGBR4 & $0{,}0229$ & MARCOPOLO PN N2 - POMO4 & $0{,}0027$ \\
Vinci Partners & VALE ON N1 - VALE3 & $0{,}0365$ & VALID ON NM - VLID3 & $0{,}0005$ \\
Vinci Partners & TENDA ON - TEND3 & $0{,}0274$ & CESP PNB N1 - CESP6 & $0{,}0008$ \\
Vinci Partners & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0210$ & GRENDENE ON NM - GRND3 & $0{,}0009$ \\
Kapitalo Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0338$ & RODOBENSIMOB ON NM - RDNI3 & $0{,}0001$ \\
Kapitalo Investimentos & BRF SA ON NM - BRFS3 & $0{,}0194$ & QUERO-QUERO ON NM - LJQQ3 & $0{,}0005$ \\
Kapitalo Investimentos & PETROBRAS PN - PETR4 & $0{,}0176$ & OMEGA GER ON NM - OMGE3 & $0{,}0007$ \\
AZ Quest & VALE ON N1 - VALE3 & $0{,}0337$ & IOCHP-MAXION ON NM - MYPK3 & $0{,}0003$ \\
AZ Quest & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0285$ & ALUPAR UNT N2 - ALUP11 & $0{,}0004$ \\
AZ Quest & PETROBRAS PN - PETR4 & $0{,}0285$ & COPEL PNB N1 - CPLE6 & $0{,}0007$ \\
Ibiuna Investimentos & BRADESCO PN N1 - BBDC4 & $0{,}0309$ & ENGIE BRASIL ON NM - EGIE3 & $0{,}0005$ \\
Ibiuna Investimentos & VALE ON N1 - VALE3 & $0{,}0284$ & RAIADROGASIL ON NM - RADL3 & $0{,}0015$ \\
Ibiuna Investimentos & BRASIL ON NM - BBAS3 & $0{,}0251$ & TRAN PAULIST PN N1 - TRPL4 & $0{,}0021$ \\
Opportunity & PETROBRAS PN - PETR4 & $0{,}0281$ & IHPARDINI ON NM - PARD3 & $0{,}0001$ \\
Opportunity & VALE ON N1 - VALE3 & $0{,}0273$ & BBSEGURIDADE ON NM - BBSE3 & $0{,}0001$ \\
Opportunity & ITAUSA PN N1 - ITSA4 & $0{,}0192$ & VIVARA S.A. ON NM - VIVA3 & $0{,}0003$ \\
Absolute Investimentos & LINX ON NM - LINX3 & $0{,}0261$ & D1000VFARMA ON NM - DMVF3 & $0{,}0001$ \\
Absolute Investimentos & PETROBRAS ON - PETR3 & $0{,}0214$ & OUROFINO S/A ON NM - OFSA3 & $0{,}0004$ \\
Absolute Investimentos & PETROBRAS PN - PETR4 & $0{,}0187$ & CBA ON NM - CBAV3 & $0{,}0006$ \\
Squadra Investimentos & PETROBRAS PN - PETR4 & $0{,}0250$ & BR BROKERS ON NM - BBRK3 & $0{,}0002$ \\
Squadra Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0206$ & CR2 ON NM - CRDE3 & $0{,}0003$ \\
Squadra Investimentos & VALE ON N1 - VALE3 & $0{,}0191$ & M.DIASBRANCO ON NM - MDIA3 & $0{,}0008$ \\
Truxt Investimentos & PETROBRAS PN - PETR4 & $0{,}0246$ & BR PARTNERS UNT N2 - BRBI11 & $0{,}0008$ \\
Truxt Investimentos & PETRORIO ON NM - PRIO3 & $0{,}0236$ & MOBLY ON NM - MBLY3 & $0{,}0008$ \\
Truxt Investimentos & VALE ON N1 - VALE3 & $0{,}0236$ & VIBRA ON NM - VBBR3 & $0{,}0009$ \\
Forpus Capital & MELIUZ ON NM - CASH3 & $0{,}0236$ & JALLESMACHADON NM - JALL3 & $0{,}0024$ \\
Forpus Capital & LOCAWEB ON NM - LWSA3 & $0{,}0217$ & EUCATEX PN N1 - EUCA4 & $0{,}0027$ \\
Forpus Capital & MAGAZ LUIZA ON NM - MGLU3 & $0{,}0198$ & BRADESCO PN N1 - BBDC4 & $0{,}0030$ \\
Kinea Investimentos & BRADESCO PN N1 - BBDC4 & $0{,}0229$ & ALIANSCSONAEON NM - ALSO3 & $0{,}0039$ \\
Kinea Investimentos & VALE ON N1 - VALE3 & $0{,}0186$ & SAO MARTINHO ON NM - SMTO3 & $0{,}0041$ \\
Kinea Investimentos & BRASIL ON NM - BBAS3 & $0{,}0134$ & KLABIN S/A UNT N2 - KLBN11 & $0{,}0046$ \\
Credit Suisse & PETROBRAS PN - PETR4 & $0{,}0220$ & CYRE COM-CCP ON NM - CCPR3 & $0{,}0004$ \\
Credit Suisse & VALE ON N1 - VALE3 & $0{,}0195$ & WDC NETWORKSON NM - LVTC3 & $0{,}0006$ \\
Credit Suisse & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0145$ & HBR REALTY ON NM - HBRE3 & $0{,}0007$ \\
ARX Investimentos & ASSAI ON NM - ASAI3 & $0{,}0208$ & RAIADROGASIL ON NM - RADL3 & $0{,}0012$ \\
ARX Investimentos & LINX ON NM - LINX3 & $0{,}0174$ & BANCO PAN PN N1 - BPAN4 & $0{,}0013$ \\
ARX Investimentos & B2W DIGITAL ON NM - BTOW3 & $0{,}0165$ & MODALMAIS UNT N2 - MODL11 & $0{,}0013$ \\
Sharp Capital & VALE ON N1 - VALE3 & $0{,}0197$ & TELEF BRASIL ON - VIVT3 & $0{,}0002$ \\
Sharp Capital & PETROBRAS ON - PETR3 & $0{,}0176$ & BR MALLS PAR ON NM - BRML3 & $0{,}0006$ \\
Sharp Capital & PETROBRAS PN - PETR4 & $0{,}0147$ & LAVVI ON NM - LAVV3 & $0{,}0006$ \\
BNP Paribas & VALE ON N1 - VALE3 & $0{,}0197$ & CBA ON NM - CBAV3 & $0{,}0004$ \\
BNP Paribas & PETROBRAS PN - PETR4 & $0{,}0109$ & ALUPAR UNT N2 - ALUP11 & $0{,}0005$ \\
BNP Paribas & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0099$ & OMEGA GER ON NM - OMGE3 & $0{,}0007$ \\
Caixa & VALE ON N1 - VALE3 & $0{,}0197$ & MITRE REALTYON NM - MTRE3 & $0{,}0002$ \\
Caixa & PETROBRAS PN - PETR4 & $0{,}0124$ & DIMED ON - PNVL3 & $0{,}0004$ \\
Caixa & TIM PART S/A ON NM - TIMP3 & $0{,}0110$ & CIA HERING ON NM - HGTX3 & $0{,}0004$ \\
Bradesco Asset Management & VALE ON N1 - VALE3 & $0{,}0184$ & HIDROVIAS ON NM - HBSA3 & $0{,}0012$ \\
Bradesco Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0142$ & PETRORECSA ON NM - RECV3 & $0{,}0017$ \\
Bradesco Asset Management & PETROBRAS PN - PETR4 & $0{,}0127$ & BR MALLS PAR ON NM - BRML3 & $0{,}0017$ \\
Constellation Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0181$ & CVC BRASIL ON NM - CVCB3 & $0{,}0002$ \\
Constellation Asset Management & LOJAS RENNER ON NM - LREN3 & $0{,}0141$ & FLEURY ON NM - FLRY3 & $0{,}0002$ \\
Constellation Asset Management & RUMO S.A. ON NM - RAIL3 & $0{,}0129$ & IGUATEMI ON NM - IGTA3 & $0{,}0005$ \\
Núcleo Capital & INTERMEDICA ON NM - GNDI3 & $0{,}0177$ & COMPASS PNB - PASS6 & $0{,}0010$ \\
Núcleo Capital & RUMO S.A. ON NM - RAIL3 & $0{,}0167$ & VIVEO ON NM - VVEO3 & $0{,}0019$ \\
Núcleo Capital & WEG ON NM - WEGE3 & $0{,}0149$ & TC ON NM - TRAD3 & $0{,}0027$ \\
SPX Capital & VALE ON N1 - VALE3 & $0{,}0174$ & SMART FIT ON M2 - SMFT3 & $0{,}0004$ \\
SPX Capital & BRADESCO PN N1 - BBDC4 & $0{,}0169$ & DIRECIONAL ON NM - DIRR3 & $0{,}0005$ \\
SPX Capital & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0141$ & VAMOS ON NM - VAMO3 & $0{,}0006$ \\
Santander Brasil Asset Management & VALE ON N1 - VALE3 & $0{,}0174$ & VIVEO ON NM - VVEO3 & $0{,}0005$ \\
Santander Brasil Asset Management & PETROBRAS PN - PETR4 & $0{,}0129$ & PETRORECSA ON NM - RECV3 & $0{,}0005$ \\
Santander Brasil Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0129$ & BANRISUL PNB N1 - BRSR6 & $0{,}0010$ \\
Daycoval Asset Management & VALE ON N1 - VALE3 & $0{,}0173$ & EZTEC ON NM - EZTC3 & $0{,}0038$ \\
Daycoval Asset Management & BRADESCO PN N1 - BBDC4 & $0{,}0160$ & INTERMEDICA ON NM - GNDI3 & $0{,}0039$ \\
Daycoval Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0156$ & CRUZEIRO EDUON NM - CSED3 & $0{,}0051$ \\
Atmos Capital & B3 ON NM - B3SA3 & $0{,}0168$ & IGUATEMI S.AUNT N1 - IGTI11 & $0{,}0002$ \\
Atmos Capital & GRUPO NATURAON NM - NTCO3 & $0{,}0158$ & BR PARTNERS UNT N2 - BRBI11 & $0{,}0003$ \\
Atmos Capital & AMBEV S/A ON - ABEV3 & $0{,}0103$ & DESKTOP ON NM - DESK3 & $0{,}0004$ \\
Verde Asset Management & ASSAI ON NM - ASAI3 & $0{,}0163$ & CIELO ON NM - CIEL3 & $0{,}0004$ \\
Verde Asset Management & VALE ON N1 - VALE3 & $0{,}0157$ & LINX ON NM - LINX3 & $0{,}0006$ \\
Verde Asset Management & SUZANO PAPEL ON NM - SUZB3 & $0{,}0129$ & TAESA UNT N2 - TAEE11 & $0{,}0006$ \\
Occam Brasil & VALE ON N1 - VALE3 & $0{,}0162$ & LINX ON NM - LINX3 & $0{,}0004$ \\
Occam Brasil & PETROBRAS PN - PETR4 & $0{,}0124$ & BRADESPAR PN N1 - BRAP4 & $0{,}0007$ \\
Occam Brasil & B3 ON NM - B3SA3 & $0{,}0106$ & OI ON N1 - OIBR3 & $0{,}0007$ \\
Western Asset & VALE ON N1 - VALE3 & $0{,}0143$ & BANCO PAN PN N1 - BPAN4 & $0{,}0003$ \\
Western Asset & PETROBRAS PN - PETR4 & $0{,}0109$ & GERDAU MET PN N1 - GOAU4 & $0{,}0004$ \\
Western Asset & CYRE COM-CCP ON NM - CCPR3 & $0{,}0087$ & M.DIASBRANCO ON NM - MDIA3 & $0{,}0005$ \\
Bogari Capital & ENERGISA UNT N2 - ENGI11 & $0{,}0141$ & BR BROKERS ON NM - BBRK3 & $0{,}0002$ \\
Bogari Capital & M.DIASBRANCO ON NM - MDIA3 & $0{,}0134$ & BBSEGURIDADE ON NM - BBSE3 & $0{,}0002$ \\
Bogari Capital & BANCO INTER UNT N2 - BIDI11 & $0{,}0119$ & LINX ON NM - LINX3 & $0{,}0004$ \\
Safra Asset Management & VALE ON N1 - VALE3 & $0{,}0138$ & COMPASS PNB - PASS6 & $0{,}0006$ \\
Safra Asset Management & PETROBRAS PN - PETR4 & $0{,}0129$ & PASSPN - PASS5 & $0{,}0008$ \\
Safra Asset Management & SUZANO PAPEL ON NM - SUZB3 & $0{,}0108$ & ESPACOLASER ON NM - ESPA3 & $0{,}0012$ \\
JGP & SUZANO PAPEL ON NM - SUZB3 & $0{,}0138$ & IHPARDINI ON NM - PARD3 & $0{,}0001$ \\
JGP & VALE ON N1 - VALE3 & $0{,}0126$ & BANRISUL PNB N1 - BRSR6 & $0{,}0001$ \\
JGP & PETROBRAS PN - PETR4 & $0{,}0119$ & SMILES ON NM - SMLS3 & $0{,}0002$ \\
Claritas Investimentos & VALE ON N1 - VALE3 & $0{,}0138$ & DIMED ON - PNVL3 & $0{,}0008$ \\
Claritas Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0134$ & CVC BRASIL ON NM - CVCB3 & $0{,}0008$ \\
Claritas Investimentos & CPFL ENERGIA ON NM - CPFE3 & $0{,}0117$ & AZUL PN N2 - AZUL4 & $0{,}0009$ \\
BTG Pactual & PETROBRAS PN - PETR4 & $0{,}0135$ & PASSPN - PASS5 & $0{,}0011$ \\
BTG Pactual & VALE ON N1 - VALE3 & $0{,}0123$ & CIA HERING ON NM - HGTX3 & $0{,}0015$ \\
BTG Pactual & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0094$ & QUERO-QUERO ON NM - LJQQ3 & $0{,}0016$ \\
Julius Baer Family Office & VALE ON N1 - VALE3 & $0{,}0129$ & WILSON SONS ON NM - PORT3 & $0{,}0004$ \\
Julius Baer Family Office & SABESP ON NM - SBSP3 & $0{,}0120$ & BRISANET ON NM - BRIT3 & $0{,}0005$ \\
Julius Baer Family Office & PETROBRAS PN - PETR4 & $0{,}0105$ & FOCUS ON ON NM - POWE3 & $0{,}0005$ \\
Dahlia Capital & VALE ON N1 - VALE3 & $0{,}0127$ & BLAU ON NM - BLAU3 & $0{,}0003$ \\
Dahlia Capital & TIM PART S/A ON NM - TIMP3 & $0{,}0102$ & COPEL ON N1 - CPLE3 & $0{,}0004$ \\
Dahlia Capital & PETROBRAS PN - PETR4 & $0{,}0069$ & MATER DEI ON EB NM - MATD3 & $0{,}0005$ \\
Itaú & VALE ON N1 - VALE3 & $0{,}0126$ & PASSPN - PASS5 & $0{,}0006$ \\
Itaú & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0099$ & SMART FIT ON M2 - SMFT3 & $0{,}0008$ \\
Itaú & PETROBRAS PN - PETR4 & $0{,}0088$ & GRUPO MATEUSON NM - GMAT3 & $0{,}0010$ \\
XP & VALE ON N1 - VALE3 & $0{,}0124$ & ALIANSCSONAEON NM - ALSO3 & $0{,}0007$ \\
XP & REDE D OR ON NM - RDOR3 & $0{,}0095$ & GRUPO MATEUSON NM - GMAT3 & $0{,}0009$ \\
XP & VIAVAREJO ON N2 - VVAR3 & $0{,}0089$ & VIVARA S.A. ON NM - VIVA3 & $0{,}0009$ \\
BB Asset Management & VALE ON N1 - VALE3 & $0{,}0119$ & CEMIG ON N1 - CMIG3 & $0{,}0007$ \\
BB Asset Management & P.ACUCAR-CBD PN N1 - PCAR4 & $0{,}0096$ & BRADESCO ON N1 - BBDC3 & $0{,}0008$ \\
BB Asset Management & PETROBRAS PN - PETR4 & $0{,}0086$ & LINX ON NM - LINX3 & $0{,}0008$ \\
Real Investor & VALE ON N1 - VALE3 & $0{,}0093$ & IMC S/A ON NM - MEAL3 & $0{,}0016$ \\
Real Investor & BRASIL ON NM - BBAS3 & $0{,}0091$ & CYRE COM-CCP ON NM - CCPR3 & $0{,}0019$ \\
Real Investor & NEOENERGIA ON ATZ NM - NEOE3 & $0{,}0091$ & GRENDENE ON NM - GRND3 & $0{,}0023$ \\
TNA Gestão Patrimonial & COSAN ON NM - CSAN3 & $0{,}0072$ & CVC BRASIL ON NM - CVCB3 & $0{,}0001$ \\
TNA Gestão Patrimonial & GRUPO NATURAON NM - NTCO3 & $0{,}0064$ & WILSON SONS ON NM - PORT3 & $0{,}0002$ \\
TNA Gestão Patrimonial & PETROBRAS DISTRIB ON - BRDT3 & $0{,}0055$ & SMART FIT ON M2 - SMFT3 & $0{,}0004$ \\
Gávea Investimentos & VIAVAREJO ON N2 - VVAR3 & $0{,}0032$ & GERDAU PN N1 - GGBR4 & $0{,}0003$ \\
Gávea Investimentos & VALE ON N1 - VALE3 & $0{,}0028$ & CESP PNB N1 - CESP6 & $0{,}0004$ \\
Gávea Investimentos & GRUPO NATURAON NM - NTCO3 & $0{,}0025$ & TRISUL ON NM - TRIS3 & $0{,}0004$ \\
\end{longtable}
\end{center}

\aha{\textbf{VALE3 domina como o ativo mais difícil de prever}: $19$ das $39$ gestoras
($49\%$) têm VALE3 como o ativo de \textbf{maior} erro fora da amostra (rank~1); olhando o
top-3 inteiro, $29$ das $39$ ($74\%$) têm VALE3 em algum dos três, e $33$ das $39$ ($85\%$) têm
VALE3, Petrobras \textbf{ou} Itaú Unibanco --- as três \emph{blue chips} mais líquidas do
Ibovespa dominam o erro fora da amostra de quase toda gestora, independente do book específico
dela. Não é coincidência --- confirma, com uma terceira metodologia independente, o mesmo padrão
já visto na Tabela~20 (VALE3 é o $2^o$ ativo com erro mais disperso \textbf{dentro} da amostra,
atrás só da Petrobras) e discutido na Seção~6.2 (o beta do fundo, que mais separa fundos
``equity-like'' de ``conservadores'', é dominado pela variação nessas ações mais representativas
do índice). Pro robô: mesmo dentro de gestoras consideradas ``previsíveis'' no agregado
(Tabela~25), VALE3/Petrobras/Itaú Unibanco são candidatas naturais a ficarem de fora de qualquer
tentativa de replicar posições com alta confiança --- o erro se concentra nelas de forma
sistemática, gestora após gestora. O lado ``menos erro'' é mais idiossincrático: cada gestora tem
seus próprios ativos-âncora, sem um padrão de concentração parecido.}

\subsubsection*{O mesmo panorama, em $h{=}3$}

\pergunta{A Tabela~27 é toda em $h{=}1$. O mesmo padrão de dominância de VALE3, Petrobras e Itaú
Unibanco se mantém prevendo $3$ meses à frente?}

Mesma construção da Tabela~27 (top-3 ativos com mais/menos erro fora da amostra por gestora,
mesmo filtro de peso mediano $>0{,}1\%$ e $\geq24$ observações), agora com $h{=}3$ --- reaproveita
a mesma base gestora-ativo já calculada no script~46, só troca o horizonte.

\begin{center}\scriptsize
\begin{longtable}{@{}lp{3.9cm}rp{3.9cm}r@{}}
\caption{Top-3 ativos com mais e menos erro fora da amostra ($h{=}3$), por gestora --- ordenado
do maior RMSE (rank 1) para o menor.}\\
\toprule
Gestora & Ativo (mais erro) & RMSE & Ativo (menos erro) & RMSE \\
\midrule
\endfirsthead
\multicolumn{5}{l}{\textit{Tabela 28 (continuação)}}\\
\toprule
Gestora & Ativo (mais erro) & RMSE & Ativo (menos erro) & RMSE \\
\midrule
\endhead
...
\texttt{47\_tabela\_erro\_ativo\_por\_gestora.R}).}\\
\endlastfoot
Guepardo Investimentos & JSL ON NM - JSLG3 & $0{,}0828$ & SIMPAR ON NM - SIMH3 & $0{,}0010$ \\
Guepardo Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0512$ & IMC S/A ON NM - MEAL3 & $0{,}0032$ \\
Guepardo Investimentos & ULTRAPAR ON NM - UGPA3 & $0{,}0491$ & LOJAS AMERIC ON - LAME3 & $0{,}0046$ \\
Vinci Partners & VALE ON N1 - VALE3 & $0{,}0555$ & VALID ON NM - VLID3 & $0{,}0004$ \\
Vinci Partners & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0307$ & GRENDENE ON NM - GRND3 & $0{,}0011$ \\
Vinci Partners & TENDA ON - TEND3 & $0{,}0289$ & CESP PNB N1 - CESP6 & $0{,}0014$ \\
Absolute Investimentos & LINX ON NM - LINX3 & $0{,}0464$ & D1000VFARMA ON NM - DMVF3 & $0{,}0004$ \\
Absolute Investimentos & PETROBRAS ON - PETR3 & $0{,}0318$ & OUROFINO S/A ON NM - OFSA3 & $0{,}0007$ \\
Absolute Investimentos & PETROBRAS PN - PETR4 & $0{,}0297$ & YDUQS PART ON NM - YDUQ3 & $0{,}0011$ \\
Opportunity & VALE ON N1 - VALE3 & $0{,}0442$ & BBSEGURIDADE ON NM - BBSE3 & $0{,}0002$ \\
Opportunity & PETROBRAS PN - PETR4 & $0{,}0375$ & IHPARDINI ON NM - PARD3 & $0{,}0002$ \\
Opportunity & ITAUSA PN N1 - ITSA4 & $0{,}0207$ & VIVARA S.A. ON NM - VIVA3 & $0{,}0003$ \\
Forpus Capital & MELIUZ ON NM - CASH3 & $0{,}0433$ & BRADESCO PN N1 - BBDC4 & $0{,}0035$ \\
Forpus Capital & LOCAWEB ON NM - LWSA3 & $0{,}0302$ & EUCATEX PN N1 - EUCA4 & $0{,}0044$ \\
Forpus Capital & SEQUOIA LOG ON NM - SEQL3 & $0{,}0289$ & CSU CARDSYST ON NM - CARD3 & $0{,}0045$ \\
Ibiuna Investimentos & VALE ON N1 - VALE3 & $0{,}0426$ & RAIADROGASIL ON NM - RADL3 & $0{,}0017$ \\
Ibiuna Investimentos & PETROBRAS ON - PETR3 & $0{,}0419$ & TRAN PAULIST PN N1 - TRPL4 & $0{,}0025$ \\
Ibiuna Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0394$ & MRV ON NM - MRVE3 & $0{,}0047$ \\
AZ Quest & VALE ON N1 - VALE3 & $0{,}0420$ & EVEN ON NM - EVEN3 & $0{,}0003$ \\
AZ Quest & BRADESPAR PN N1 - BRAP4 & $0{,}0312$ & EZTEC ON NM - EZTC3 & $0{,}0004$ \\
AZ Quest & BRADESCO PN N1 - BBDC4 & $0{,}0303$ & MRV ON NM - MRVE3 & $0{,}0005$ \\
Truxt Investimentos & PETRORIO ON NM - PRIO3 & $0{,}0417$ & BR PARTNERS UNT N2 - BRBI11 & $0{,}0010$ \\
Truxt Investimentos & VALE ON N1 - VALE3 & $0{,}0373$ & HIDROVIAS ON NM - HBSA3 & $0{,}0017$ \\
Truxt Investimentos & MAGAZ LUIZA ON NM - MGLU3 & $0{,}0322$ & ALUPAR UNT N2 - ALUP11 & $0{,}0017$ \\
Núcleo Capital & WEG ON NM - WEGE3 & $0{,}0381$ & TC ON NM - TRAD3 & $0{,}0031$ \\
Núcleo Capital & INTERMEDICA ON NM - GNDI3 & $0{,}0369$ & VIVEO ON NM - VVEO3 & $0{,}0037$ \\
Núcleo Capital & RAIADROGASIL ON NM - RADL3 & $0{,}0220$ & INFRACOMM ON NM - IFCM3 & $0{,}0052$ \\
Kinea Investimentos & BRADESCO PN N1 - BBDC4 & $0{,}0338$ & SAO MARTINHO ON NM - SMTO3 & $0{,}0055$ \\
Kinea Investimentos & VALE ON N1 - VALE3 & $0{,}0297$ & LOCAWEB ON NM - LWSA3 & $0{,}0062$ \\
Kinea Investimentos & BRASIL ON NM - BBAS3 & $0{,}0275$ & COSAN ON NM - CSAN3 & $0{,}0068$ \\
Sharp Capital & VALE ON N1 - VALE3 & $0{,}0325$ & TELEF BRASIL ON - VIVT3 & $0{,}0004$ \\
Sharp Capital & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0257$ & BANCO INTER PN N2 - BIDI4 & $0{,}0004$ \\
Sharp Capital & PETRORIO ON NM - PRIO3 & $0{,}0246$ & BR MALLS PAR ON NM - BRML3 & $0{,}0008$ \\
Squadra Investimentos & PETROBRAS PN - PETR4 & $0{,}0320$ & BR BROKERS ON NM - BBRK3 & $0{,}0003$ \\
Squadra Investimentos & PETRORIO ON NM - PRIO3 & $0{,}0224$ & CR2 ON NM - CRDE3 & $0{,}0004$ \\
Squadra Investimentos & EQUATORIAL ON NM - EQTL3 & $0{,}0222$ & EQTL PARA ON - EQPA3 & $0{,}0016$ \\
SPX Capital & VALE ON N1 - VALE3 & $0{,}0296$ & GUARARAPES ON - GUAR3 & $0{,}0004$ \\
SPX Capital & BRADESCO PN N1 - BBDC4 & $0{,}0206$ & MODALMAIS UNT N2 - MODL11 & $0{,}0008$ \\
SPX Capital & GRUPO NATURAON NM - NTCO3 & $0{,}0188$ & PETRORECSA ON NM - RECV3 & $0{,}0014$ \\
Constellation Asset Management & SUZANO PAPEL ON NM - SUZB3 & $0{,}0285$ & ELETROBRAS PNB N1 - ELET6 & $0{,}0005$ \\
Constellation Asset Management & COSAN ON NM - CSAN3 & $0{,}0263$ & VIVEO ON NM - VVEO3 & $0{,}0014$ \\
Constellation Asset Management & LOJAS RENNER ON NM - LREN3 & $0{,}0227$ & MOSAICO SA ON NM - MOSI3 & $0{,}0016$ \\
Caixa & VALE ON N1 - VALE3 & $0{,}0283$ & MITRE REALTYON NM - MTRE3 & $0{,}0004$ \\
Caixa & PETROBRAS PN - PETR4 & $0{,}0172$ & DIMED ON - PNVL3 & $0{,}0007$ \\
Caixa & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0143$ & CIA HERING ON NM - HGTX3 & $0{,}0009$ \\
Verde Asset Management & ASSAI ON NM - ASAI3 & $0{,}0280$ & CIELO ON NM - CIEL3 & $0{,}0006$ \\
Verde Asset Management & SUZANO PAPEL ON NM - SUZB3 & $0{,}0252$ & QUALICORP ON NM - QUAL3 & $0{,}0010$ \\
Verde Asset Management & VALE ON N1 - VALE3 & $0{,}0246$ & FLEURY ON NM - FLRY3 & $0{,}0010$ \\
Credit Suisse & VALE ON N1 - VALE3 & $0{,}0277$ & CYRE COM-CCP ON NM - CCPR3 & $0{,}0005$ \\
Credit Suisse & PETROBRAS PN - PETR4 & $0{,}0267$ & WDC NETWORKSON NM - LVTC3 & $0{,}0009$ \\
Credit Suisse & PETRORIO ON NM - PRIO3 & $0{,}0180$ & HBR REALTY ON NM - HBRE3 & $0{,}0010$ \\
Western Asset & VALE ON N1 - VALE3 & $0{,}0275$ & GERDAU MET PN N1 - GOAU4 & $0{,}0007$ \\
Western Asset & PETROBRAS PN - PETR4 & $0{,}0136$ & IGUATEMI ON NM - IGTA3 & $0{,}0007$ \\
Western Asset & GRUPO NATURAON NM - NTCO3 & $0{,}0124$ & BANCO PAN PN N1 - BPAN4 & $0{,}0009$ \\
BNP Paribas & VALE ON N1 - VALE3 & $0{,}0273$ & ALUPAR UNT N2 - ALUP11 & $0{,}0008$ \\
BNP Paribas & PETROBRAS PN - PETR4 & $0{,}0172$ & OMEGA GER ON NM - OMGE3 & $0{,}0009$ \\
BNP Paribas & BRADESCO PN N1 - BBDC4 & $0{,}0138$ & CBA ON NM - CBAV3 & $0{,}0009$ \\
Bogari Capital & BANCO INTER UNT N2 - BIDI11 & $0{,}0256$ & BR BROKERS ON NM - BBRK3 & $0{,}0002$ \\
Bogari Capital & EQUATORIAL ON NM - EQTL3 & $0{,}0190$ & BK BRASIL ON NM - BKBR3 & $0{,}0008$ \\
Bogari Capital & PETROBRAS DISTRIB ON - BRDT3 & $0{,}0185$ & LOPES BRASIL ON NM - LPSB3 & $0{,}0010$ \\
Occam Brasil & VALE ON N1 - VALE3 & $0{,}0250$ & LINX ON NM - LINX3 & $0{,}0007$ \\
Occam Brasil & B3 ON NM - B3SA3 & $0{,}0201$ & BRADESPAR PN N1 - BRAP4 & $0{,}0008$ \\
Occam Brasil & PETROBRAS PN - PETR4 & $0{,}0186$ & TELEF BRASIL PN - VIVT4 & $0{,}0010$ \\
Kapitalo Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0243$ & RODOBENSIMOB ON NM - RDNI3 & $0{,}0002$ \\
Kapitalo Investimentos & BRF SA ON NM - BRFS3 & $0{,}0221$ & OMEGA GER ON NM - OMGE3 & $0{,}0013$ \\
Kapitalo Investimentos & PETROBRAS PN - PETR4 & $0{,}0213$ & MULTIPLAN ON N2 - MULT3 & $0{,}0014$ \\
Bradesco Asset Management & VALE ON N1 - VALE3 & $0{,}0240$ & HIDROVIAS ON NM - HBSA3 & $0{,}0022$ \\
Bradesco Asset Management & PETROBRAS PN - PETR4 & $0{,}0174$ & COPASA ON NM - CSMG3 & $0{,}0022$ \\
Bradesco Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0168$ & CEMIG PN N1 - CMIG4 & $0{,}0024$ \\
Atmos Capital & GRUPO NATURAON NM - NTCO3 & $0{,}0228$ & CYRELA REALT ON NM - CYRE3 & $0{,}0001$ \\
Atmos Capital & AZUL PN N2 - AZUL4 & $0{,}0212$ & DESKTOP ON NM - DESK3 & $0{,}0002$ \\
Atmos Capital & B3 ON NM - B3SA3 & $0{,}0190$ & BR PARTNERS UNT N2 - BRBI11 & $0{,}0004$ \\
Santander Brasil Asset Management & VALE ON N1 - VALE3 & $0{,}0227$ & PETRORECSA ON NM - RECV3 & $0{,}0005$ \\
Santander Brasil Asset Management & PETROBRAS PN - PETR4 & $0{,}0187$ & CVC BRASIL ON NM - CVCB3 & $0{,}0011$ \\
Santander Brasil Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0149$ & AZUL PN N2 - AZUL4 & $0{,}0014$ \\
Daycoval Asset Management & PETROBRAS PN - PETR4 & $0{,}0227$ & EZTEC ON NM - EZTC3 & $0{,}0043$ \\
Daycoval Asset Management & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0213$ & RUMO S.A. ON NM - RAIL3 & $0{,}0054$ \\
Daycoval Asset Management & ASSAI ON NM - ASAI3 & $0{,}0208$ & INTERMEDICA ON NM - GNDI3 & $0{,}0056$ \\
ARX Investimentos & VALE ON N1 - VALE3 & $0{,}0225$ & RAIADROGASIL ON NM - RADL3 & $0{,}0016$ \\
ARX Investimentos & B2W DIGITAL ON NM - BTOW3 & $0{,}0186$ & AES TIETE E UNT N2 - TIET11 & $0{,}0021$ \\
ARX Investimentos & BRADESCO PN N1 - BBDC4 & $0{,}0183$ & ELETROBRAS ON N1 - ELET3 & $0{,}0023$ \\
Dahlia Capital & VALE ON N1 - VALE3 & $0{,}0223$ & COPEL ON N1 - CPLE3 & $0{,}0006$ \\
Dahlia Capital & TIM PART S/A ON NM - TIMP3 & $0{,}0164$ & BLAU ON NM - BLAU3 & $0{,}0006$ \\
Dahlia Capital & PETROBRAS PN - PETR4 & $0{,}0132$ & MATER DEI ON EB NM - MATD3 & $0{,}0009$ \\
Claritas Investimentos & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0223$ & CVC BRASIL ON NM - CVCB3 & $0{,}0005$ \\
Claritas Investimentos & VALE ON N1 - VALE3 & $0{,}0218$ & AZUL PN N2 - AZUL4 & $0{,}0008$ \\
Claritas Investimentos & VIAVAREJO ON N2 - VVAR3 & $0{,}0161$ & BRF SA ON NM - BRFS3 & $0{,}0014$ \\
BTG Pactual & PETROBRAS PN - PETR4 & $0{,}0209$ & MULTILASER ON NM - MLAS3 & $0{,}0020$ \\
BTG Pactual & VALE ON N1 - VALE3 & $0{,}0192$ & ESPACOLASER ON NM - ESPA3 & $0{,}0022$ \\
BTG Pactual & MAGAZ LUIZA ON NM - MGLU3 & $0{,}0131$ & VIVARA S.A. ON NM - VIVA3 & $0{,}0023$ \\
BB Asset Management & VALE ON N1 - VALE3 & $0{,}0201$ & TRACK FIELD PN N2 - TFCO4 & $0{,}0011$ \\
BB Asset Management & SID NACIONAL ON - CSNA3 & $0{,}0145$ & BRADESCO ON N1 - BBDC3 & $0{,}0011$ \\
BB Asset Management & PETROBRAS PN - PETR4 & $0{,}0122$ & CEMIG ON N1 - CMIG3 & $0{,}0014$ \\
Safra Asset Management & VALE ON N1 - VALE3 & $0{,}0190$ & PASSPN - PASS5 & $0{,}0016$ \\
Safra Asset Management & SUZANO PAPEL ON NM - SUZB3 & $0{,}0180$ & ESPACOLASER ON NM - ESPA3 & $0{,}0019$ \\
Safra Asset Management & PETROBRAS PN - PETR4 & $0{,}0169$ & VIVARA S.A. ON NM - VIVA3 & $0{,}0022$ \\
XP & VALE ON N1 - VALE3 & $0{,}0180$ & SMART FIT ON M2 - SMFT3 & $0{,}0009$ \\
XP & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0142$ & ALIANSCSONAEON NM - ALSO3 & $0{,}0011$ \\
XP & REDE D OR ON NM - RDOR3 & $0{,}0129$ & GRUPO MATEUSON NM - GMAT3 & $0{,}0013$ \\
Real Investor & BR PROPERT ON NM - BRPR3 & $0{,}0175$ & IMC S/A ON NM - MEAL3 & $0{,}0028$ \\
Real Investor & NEOENERGIA ON ATZ NM - NEOE3 & $0{,}0170$ & GRENDENE ON NM - GRND3 & $0{,}0037$ \\
Real Investor & ALIANSCSONAEON NM - ALSO3 & $0{,}0170$ & CYRE COM-CCP ON NM - CCPR3 & $0{,}0039$ \\
Itaú & VALE ON N1 - VALE3 & $0{,}0171$ & PASSPN - PASS5 & $0{,}0011$ \\
Itaú & ITAUUNIBANCO PN N1 - ITUB4 & $0{,}0134$ & GRUPO MATEUSON NM - GMAT3 & $0{,}0016$ \\
Itaú & PETROBRAS PN - PETR4 & $0{,}0118$ & SMART FIT ON M2 - SMFT3 & $0{,}0018$ \\
JGP & COSAN ON NM - CSAN3 & $0{,}0170$ & IHPARDINI ON NM - PARD3 & $0{,}0001$ \\
JGP & SUZANO PAPEL ON NM - SUZB3 & $0{,}0147$ & SER EDUCA ON NM - SEER3 & $0{,}0001$ \\
JGP & VALE ON N1 - VALE3 & $0{,}0141$ & SMILES ON NM - SMLS3 & $0{,}0003$ \\
Julius Baer Family Office & VALE ON N1 - VALE3 & $0{,}0168$ & BRADESPAR ON N1 - BRAP3 & $0{,}0009$ \\
Julius Baer Family Office & SABESP ON NM - SBSP3 & $0{,}0133$ & SMART FIT ON M2 - SMFT3 & $0{,}0009$ \\
Julius Baer Family Office & PETROBRAS PN - PETR4 & $0{,}0129$ & FOCUS ON ON NM - POWE3 & $0{,}0009$ \\
TNA Gestão Patrimonial & COSAN ON NM - CSAN3 & $0{,}0099$ & CVC BRASIL ON NM - CVCB3 & $0{,}0003$ \\
TNA Gestão Patrimonial & GRUPO NATURAON NM - NTCO3 & $0{,}0083$ & 3TENTOS ON NM - TTEN3 & $0{,}0006$ \\
TNA Gestão Patrimonial & VALE ON N1 - VALE3 & $0{,}0072$ & EMBRAER ON NM - EMBR3 & $0{,}0006$ \\
Gávea Investimentos & VIAVAREJO ON N2 - VVAR3 & $0{,}0061$ & BR MALLS PAR ON NM - BRML3 & $0{,}0002$ \\
Gávea Investimentos & VALE ON N1 - VALE3 & $0{,}0049$ & CESP PNB N1 - CESP6 & $0{,}0006$ \\
Gávea Investimentos & SUZANO PAPEL ON NM - SUZB3 & $0{,}0048$ & HIDROVIAS ON NM - HBSA3 & $0{,}0006$ \\
\end{longtable}
\end{center}

\aha{\textbf{O mesmo padrão se mantém em $h{=}3$}: $28$ das $39$ gestoras ($72\%$) têm VALE3
em algum dos três ativos de maior erro (era $29$ em $h{=}1$); $32$ ($82\%$) têm VALE3 ou
Petrobras; $33$ ($85\%$) têm VALE3, Petrobras \textbf{ou} Itaú Unibanco --- número idêntico ao de
$h{=}1$. A dominância dessas três \emph{blue chips} não é um artefato de olhar só $1$ mês à
frente; é estável mesmo prevendo $3$ meses. Um detalhe novo: Petrobras \textbf{ON} (PETR3, não só
a PN mais líquida PETR4) aparece no top-3 de várias gestoras em $h{=}3$ que não apareciam em
$h{=}1$ (Absolute, Ibiuna, Sharp, Squadra, Truxt, Credit Suisse) --- sinal de que, em horizontes
mais longos, o erro se espalha um pouco mais entre as duas classes de ação da Petrobras, não só
na mais líquida.}
...
\item \textbf{Qual ativo específico puxa o erro, por gestora (top-3, $h=1$ e $h=3$):} quebrando o
erro fora da amostra por (gestora, ativo), em $h=1$ $29$ das $39$ gestoras elegíveis ($74\%$) têm
\textbf{VALE3} em algum dos três ativos de maior erro, e $33$ ($85\%$) têm VALE3, Petrobras
\textbf{ou} Itaú Unibanco --- em $h=3$ o padrão se repete quase idêntico ($28$ e $33$
respectivamente). A dominância dessas três \emph{blue chips} não é um artefato de olhar só $1$
mês à frente. Confirma, com uma terceira metodologia independente, o mesmo padrão da Tabela~20
(VALE3 é o $2^o$ ativo com erro mais disperso dentro da amostra) --- mesmo gestoras consideradas
``previsíveis'' no agregado erram sistematicamente mais nessas \emph{blue chips}.
\end{enumerate}
