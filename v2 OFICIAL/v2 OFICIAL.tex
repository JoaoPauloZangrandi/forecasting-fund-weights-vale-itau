...
\FloatBarrier
\subsection{O erro por gestora: quem o modelo explica melhor}

\pergunta{O erro $e$ da cross-section (Seção~2.2) é parecido entre gestoras, ou tem gestoras que
o modelo explica muito melhor que outras?}
...
mês. Média do erro por gestora é, portanto, zero por construção, não uma medida útil. O que sobra
informativo é a \textbf{dispersão} do erro dentro de cada gestora --- quanto maior, mais difícil
o modelo (mesmo com a dummy) explica a alocação daquele grupo em VALE3.
...
menos para o mais disperso). Nos extremos: gestoras \emph{boutique} concentradas e de renda
variável pura --- Verde, Opportunity, Vinci Partners, Sharp, BTG --- têm o erro mais disperso
($\text{dp}\approx0{,}034$--$0{,}035$, quase o dobro do Itaú); gestoras com mandatos mais amplos
ou passivos --- TNA, Kinea, Plural, Squadra, Daycoval --- têm o erro bem mais concentrado
...
% ======================================================================
\FloatBarrier
\section{O robô caça-replicantes: erro por fundo individual}
\label{sec:robo}

\pergunta{A Seção~\ref{sec:gestoras} mostrou que a \emph{dispersão} do erro varia por gestora ---
mas dentro de uma mesma gestora, todo fundo se comporta igual, ou tem fundo que segue a fórmula
``no automático'' e fundo que claramente está fazendo uma aposta própria?}
...
5 características previam que o fundo carregasse de VALE3 --- e a resposta é o peso real. Um
\textbf{fundo replicante} tem erro $e$ pequeno mês após mês: sua alocação é basicamente uma
função das características genéricas, sem sinal de decisão própria. Um \textbf{fundo humano} tem
erro grande e persistente: alguém ali está apostando em VALE3 de um jeito que a fórmula não
capta.

\textbf{Adendo sobre o escore:} no nível gestora (Seção~\ref{sec:gestoras}), a \emph{média} do
erro é zero por construção (efeito-fixo absorve). No nível fundo isso \textbf{não} vale --- cada
fundo é só uma entre várias observações que alimentam a dummy da sua gestora, então a média do
erro de um fundo específico pode se afastar bastante de zero (média de $|\bar e_i|$ entre os
fundos: $0{,}014$, bem acima de zero). O escore usado é o \textbf{MAE do erro} de cada fundo ao
longo do tempo --- combina viés sistemático e volatilidade num número só. Amostra: fundos com
$\geq24$ meses de histórico (mesmo corte da Seção~\ref{sec:multiativo}), $1.282$ dos $2.257$
fundos da Seção~\ref{sec:gestoras}.

\begin{table}[h]\centering\scriptsize
\caption{Os 10 fundos mais ``replicantes'' (menor MAE) e os 10 mais ``humanos'' (maior MAE).}
\begin{tabular}{@{}rlrr@{}}
\toprule
\multicolumn{4}{c}{\textbf{Mais replicantes}} \\
Cód. fundo & Gestora & Meses & MAE \\
\midrule
274100 & Guepardo Investimentos & 32 & $0{,}00045$ \\
150568 & Itaú & 59 & $0{,}00161$ \\
394165 & Forpus Capital & 33 & $0{,}00163$ \\
211613 & Itaú & 38 & $0{,}00165$ \\
358495 & TNA Gestão Patrimonial & 59 & $0{,}00183$ \\
136883 & Itaú & 30 & $0{,}00188$ \\
339628 & Itaú & 52 & $0{,}00200$ \\
68675 & Itaú & 31 & $0{,}00205$ \\
386588 & Atmos Capital & 32 & $0{,}00206$ \\
123641 & Itaú & 59 & $0{,}00209$ \\
\midrule
\multicolumn{4}{c}{\textbf{Mais humanos}} \\
Cód. fundo & Gestora & Meses & MAE \\
\midrule
191914 & BTG Pactual & 53 & $\mathbf{0{,}25115}$ \\
481041 & Itaú & 24 & $0{,}07123$ \\
218421 & Itaú & 26 & $0{,}06985$ \\
110108 & Itaú & 26 & $0{,}06710$ \\
212891 & BTG Pactual & 24 & $0{,}06413$ \\
130958 & Safra Asset Management & 30 & $0{,}06230$ \\
426717 & Opportunity & 50 & $0{,}06107$ \\
337285 & BB Asset Management & 27 & $0{,}05779$ \\
292826 & Vinci Partners & 38 & $0{,}05307$ \\
49336 & Safra Asset Management & 33 & $0{,}05298$ \\
\bottomrule
\end{tabular}
\caption*{\footnotesize Fonte: elaboração própria (\texttt{scripts/35\_robo\_replicante.R}).}
\end{table}

\begin{figure}[h]\centering
\includegraphics[width=0.75\textwidth]{hist_mae_fundo_v2.pdf}
\caption{Distribuição do MAE do erro $e$ entre os $1.282$ fundos elegíveis.}
\end{figure}

\aha{A distribuição é bem assimétrica: mediana de MAE $=0{,}0115$, mas o percentil $90$ já é
$0{,}0294$ e o fundo mais extremo chega a $0{,}251$ --- mais de $20\times$ a mediana. Como
checagem de convergência com a Seção~\ref{sec:gestoras}: a média do MAE dos fundos elegíveis de
cada gestora tem correlação de $0{,}92$ com o desvio-padrão do erro daquela gestora (Tabela~8)
--- os dois níveis de análise (gestora e fundo) apontam para a mesma leitura, o que reforça que a
dispersão por gestora não é ruído de agregação.}

O fundo mais ``humano'' de toda a amostra ($191914$, BTG Pactual) ilustra bem o padrão: não é erro
de dado (peso sempre dentro de $[0,1]$), é um fundo que carrega VALE3 de forma persistente e
crescentemente descolada do que as características preveem.

\begin{figure}[H]\centering
\includegraphics[width=0.85\textwidth]{fig_erro_fundo_extremo_v2.pdf}
\caption{Peso real vs.\ previsto pela fórmula, fundo $191914$ (BTG Pactual) --- o caso mais
``humano'' da amostra.}
\end{figure}

\aha{Em ago/2017 o fundo já carregava $27\%$ em VALE3 contra um previsto de $5\%$; a partir de
2020 a divergência só cresce, terminando dez/2021 em $50\%$ de peso real contra $7\%$ previsto.
Nenhuma das 5 características (tamanho, cotistas, FIC, fluxo, beta do fundo) evolui o suficiente
para explicar esse movimento --- é o oposto exato de um fundo replicante: uma aposta concentrada e
crescente num único papel, que a fórmula genérica nunca vai captar porque ela foi desenhada para
explicar o comportamento médio, não a convicção individual de um gestor específico.}
...
(efeito-fixo absorve); a \emph{dispersão} não é --- boutiques de convicção concentrada (Verde,
Opportunity, Vinci, Sharp, BTG) têm erro até o dobro mais disperso que gestoras de mandato amplo
(TNA, Kinea, Plural), sinal de que as cinco características explicam pior a alocação de gestoras
concentradas.
...
\item \textbf{O robô caça-replicantes (Seção~\ref{sec:robo}):} descendo do nível gestora para o
nível fundo, o MAE do erro $e$ de cada fundo ($1.282$ com $\geq24$ meses de histórico) separa
fundos ``replicantes'' (alocação bem explicada pelas 5 características) de fundos ``humanos''
(alocação que a fórmula não capta). Convergência forte com a Seção~\ref{sec:gestoras}: correlação
de $0{,}92$ entre o MAE médio dos fundos de uma gestora e a dispersão já reportada por gestora. O
caso mais extremo (fundo $191914$, BTG Pactual) mostra uma aposta concentrada e crescente em
VALE3 (de $27\%$ para $50\%$ de peso) que nenhuma das 5 características explica.
\end{enumerate}
