...
\midrule
\endfirsthead
\multicolumn{5}{l}{\textit{Tabela 14 (continuação)}}\\
\toprule
Gestora & Fundos & Meses & Efeito-fixo & vs.\ Itaú \\
\midrule
\endhead
...
com o log). É o padrão estatístico esperado (menos fundos = mais ruído na estimativa do
efeito-fixo daquela gestora), não um erro de cálculo --- mas fica mais claro com a coluna à vista:
a \textbf{Legacy Capital} ($6^o$ lugar) tem só $1$ fundo em $2$ meses; Real Investor ($4^o$) e
Forpus ($12^o$) têm $5$ e $3$ fundos. Mesmo a \textbf{Guepardo}, no topo, tem só $15$ fundos ---
poucos perto do Itaú ($524$) ou Bradesco ($331$), que ficam nos dois últimos lugares. Não invalida
o achado (fica reforçado pela Tabela~18, uma metodologia bem diferente), mas os extremos com
