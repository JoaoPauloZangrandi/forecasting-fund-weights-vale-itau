...
#
# Evolucao mensal do APE de gestora (vs. Itau, em pontos percentuais) para
# as 5 gestoras mais positivas e as 5 mais negativas de verdade (ranking
# pelo APE medio, sem filtro de cobertura minima -- um filtro >=45 meses
# aqui escondia os extremos reais da Tabela 8 atras de substitutos com mais
# cobertura, ex.: Kapitalo aparecia como "5a mais negativa" quando na
# verdade e a 8a. Corrigido apos o Joao flagrar a incoerencia). LOGIT (nao
# mais linear): plota o APE, nao o coeficiente log-odds bruto, porque o
# APE e' que tem leitura direta em pontos percentuais. Mostrar todas as 40
# num grafico so seria ilegivel.
...
cat("Top 5 (mais positivas, ranking real por APE):", paste(top5, collapse=", "), "\n")
cat("Bottom 5 (mais negativas, ranking real por APE):", paste(bot5, collapse=", "), "\n")
