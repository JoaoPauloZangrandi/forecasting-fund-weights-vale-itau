...
\midrule
Universo bruto com posição em ações, 2016 a 2021 & 3.254 & --- & 41 \\
...
\end{tabular}
\caption*{\footnotesize Fonte: elaboração própria a partir de dados da Comissão de Valores
Mobiliários. A contagem de ativos não se aplica à primeira linha porque um ativo só passa a
ser identificado depois do filtro de posição direta. A cobertura temporal da amostra final é
