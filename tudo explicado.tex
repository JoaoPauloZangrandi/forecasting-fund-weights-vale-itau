...
\begin{tabular}{@{}lccc@{}}
\toprule
Coeficiente & Direção (VALE3) & \% dos 361 ativos igual & VALE3 é típico? \\
\midrule
$\ln$(PL)         & negativo & $92{,}5\%$ & \textbf{não} --- percentil 1 (extremo) \\
$\ln$(cotistas)   & positivo & $98{,}9\%$ & sim \\
Fundo de cotas     & negativo & $92{,}8\%$ & sim \\
Captação/PL       & fraco/instável & $52{,}6\%$ positivo & ambíguo nos dois \\
\bottomrule
\end{tabular}
\end{center}
...
distribuem posições em ações conforme o perfil do fundo. Mas a \textbf{magnitude} do efeito de
tamanho de VALE3 é atípica: seu coeficiente médio ($-0{,}00566$) está no \textbf{percentil 1} da
distribuição entre os 361 ativos --- VALE3 é um dos papéis cujo peso reage mais fortemente ao
porte do fundo, não um caso representativo. Uma checagem independente, empilhando as 1,50 milhão
...
do Itaú carregam. A \textbf{magnitude} do efeito de VALE3, porém, é atípica (percentil 1 no efeito
de tamanho): é um papel extremo nessa dimensão, não representativo.
