...
\paragraph{Passo 2 --- regressão logística (resposta fracionária) do peso. \fazer} Reestimar
\eqref{eq:cs} com a ligação logística da \eqref{eq:logit} (em R, \texttt{glm} com família
\texttt{quasibinomial}). Objetivo: respeitar o suporte $[0,1]$ e comparar com a versão linear; em
geral muda pouco no centro da distribuição, mas evita previsões fora de $[0,1]$.
