...
um modelo de resposta fracionária. Os resultados confirmam a leitura linear: os sinais e a
significância das características são idênticos, e os efeitos parciais médios --- a resposta em
pontos de peso, comparável aos coeficientes lineares --- praticamente coincidem, com cerca de
$-0{,}68$ ponto percentual para o patrimônio, $+1{,}06$ para o número de cotistas e $-1{,}60$ para
fundo de cotas, por desvio padrão. A vantagem da forma logística aparece nos extremos: a regressão
linear gera pesos ajustados fora do intervalo entre zero e um em $2{,}51$ por cento das
observações, valores sem sentido para uma participação, ao passo que a logística os respeita por
construção, e o ajuste melhora ligeiramente (pseudo-coeficiente de determinação de $0{,}165$
contra $0{,}152$). É essa forma que fornece o peso desejado usado no modelo de ajuste parcial. A
estimação está no script \texttt{R/25}.
