...
Toda esta seção usa a base multiativo já limpa: dos 2.347 fundos da Tabela~\ref{tab:amostra},
597 fundo-mês (73 fundos) têm soma de peso $>105\%$ do patrimônio --- erro de reporte
identificado na CDA da CVM, não deste trabalho --- e são excluídos antes de qualquer regressão,
restando \textbf{2.343 fundos, 41 gestoras, 501 ativos}. Uma única base do início ao fim,
diferente de versões anteriores deste documento.
