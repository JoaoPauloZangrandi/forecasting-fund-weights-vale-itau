...
\emph{[Seção a ser escrita após a Introdução. Deve mencionar $\text{HHI}_{\text{resto}}$ como
parte do modelo final (Etapa 1, equação~\eqref{eq:hhi-resto}), não como extensão em
avaliação.]}
