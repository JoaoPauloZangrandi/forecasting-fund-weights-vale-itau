...
\midrule
Universo bruto CVM com posição em ações, 2016 a 2021 & 3.254 & n.a. & 41 \\
...
\end{frame}
% ---------------------------------------------------------------- 3
\begin{frame}{Onde o trabalho entra na literatura}

Três correntes sustentam o desenho, e cada uma para num ponto diferente.

\vspace{0.35em}
\centering
\footnotesize
\begin{tabular}{@{}p{2.7cm}p{4.2cm}p{6.9cm}@{}}
\toprule
Corrente & Referências & Até onde ela vai \\
\midrule
Precificação baseada em demanda
& Koijen e Yogo (2019); Gabaix e Koijen (2021)
& Estima o sistema de demanda a partir de carteiras e mostra que o
  rebalanceamento institucional move o preço. O objeto final é o preço, com
  investidor americano. \\[0.3em]
Fluxo e negociação institucional
& Lakonishok, Shleifer e Vishny (1992); Coval e Stafford (2007); Lou (2012)
& Documenta que a negociação do fundo move o preço e que o fluxo prevê retorno.
  Mede fluxo e retorno, não o peso de cada posição. \\[0.3em]
Ajuste parcial
& Fama e French (2002); Flannery e Rangan (2006); Calvet, Campbell e Sodini (2009)
& Mede a velocidade de convergência a um alvo, em alavancagem de firma e em
  carteira de pessoa física. O alvo é tomado como dado. \\
\bottomrule
\end{tabular}
...
\raggedright
\small
Nenhuma delas percorre sozinha a cadeia que vai da característica do fundo ao peso previsto,
deste à velocidade de ajuste e desta ao desempenho fora da amostra. É essa cadeia que o
trabalho monta, com o alvo estimado dentro do próprio modelo, num painel brasileiro de base
pública onde a evidência é escassa.
...
Razão entre os dois & $0{,}9848$ & $0{,}9686$ & $0{,}9522$ & $0{,}9291$ \\
...
\centering
\includegraphics[width=0.96\linewidth]{fig_dinamica_erro_gestora_extremos.pdf}

\vspace{0.1em}
\scriptsize
Erro médio mensal fora da amostra, $h=1$. À esquerda, as três gestoras mais difíceis de
prever; à direita, as três mais previsíveis, na mesma escala.
\end{column}
...
Uma regressão entre as 40 gestoras, com a dependente medida só no teste e as explicativas só
no treino:
\begin{align*}
\text{dp}(\text{erro})_g = {}& \alpha + \beta_1\,\overline{\text{beta}}_g
 + \beta_2\,\overline{\log(\text{PL})}_g + \beta_3\,\overline{\log(\text{cotistas})}_g \\[-0.15em]
 & + \beta_4\,\overline{\text{FIC}}_g + \beta_5\,\overline{\text{fluxo}}_g
 + \beta_6\,\overline{\text{HHI}}_g + \varepsilon_g
\end{align*}
...
\small
Correlação entre concentração e erro, agora no nível de fundo e mês:
...
\vspace{0.6em}
\raggedright
As duas primeiras quase iguais afastam coincidência de mês. A terceira, perto de zero, mostra
que a concentração separa fundos, e não meses de um mesmo fundo.
\end{column}
\end{columns}
